...
//in natural units
class lepton {
  private: std::string particle_type;
  double rest_mass;
  int charge;
  ...
  ~lepton();
  void set_particle_type(const std::string & input_particle_type) {
    particle_type = input_particle_type;
  }
  void set_rest_mass(double input_mass) {
    rest_mass = input_mass;
  }
  ...
  double get_momentum_magnitude() const {
