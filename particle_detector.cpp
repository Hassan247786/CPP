...
class lepton {
  ...
  public: lepton() =
    default;
  lepton(const std::string input_particle_type, double input_mass, int input_charge, double input_velocity): particle_type {
    input_particle_type
  },
  rest_mass {
    input_mass
...
class lepton_detector {
  private: std::string detector_type;
  bool detector_status;
  int number_of_particles;
  public: lepton_detector() =
    default;
  lepton_detector(const std::string & input_detector_type,
    const bool & input_detector_status): detector_type {
    input_detector_type
  },
  detector_status {
    input_detector_status
  },
  number_of_particles {
    0
  } {}
  ...
  void print_detector_data() const {
